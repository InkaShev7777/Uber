...
struct RideRequestView: View {
    @State private var isOrderedCar = false
    ...
    var body: some View {
        VStack {
            if !isOrderedCar {
                ...
                Button {
                    self.isOrderedCar.toggle()
                    self.notificationManager.sentNotification(with: "UBER", body: "Your driver has arrived and is waiting for you", date: Date())
                } label: {
                    Text("CONFIRM RIDE")
                        .fontWeight(.bold)
